...
#        ('DeleteLine',        None, 'Delete Line(s)',         '<Control>e',              "Delete Line",         lambda a,w: delete_line(w)),
        ('DuplicateLineUp',   None, 'Duplicate Line(s) Up',   '<Alt>q',                  "Duplicate Line Up",   lambda a,w: duplicate_line(w, down=False)),
        ('DuplicateLineDown', None, 'Duplicate Line(s) Down', '<Alt>a',                  "Duplicate Line Down", lambda a,w: duplicate_line(w, down=True)),
#        ('MoveLineUp',        None, 'Move Line(s) Up',        '<Shift><Alt>q',           "Move Line Up",        lambda a,w: move_line(w, down=False)),
#        ('MoveLineDown',      None, 'Move Line(s) Down',      '<Shift><Alt>a',           "Move Line Down",      lambda a,w: move_line(w, down=True)),
